                        ...
                        <div className="flex flex-col gap-6">
                            <div>
                                <Typography className="mbe-4">
                                    If you&apos;re after only one item, simply choose the &apos;Buy Now&apos; option on
                                    the item page. This will take you directly to Checkout.
                                </Typography>
                                <Typography>
                            ...
                            />
                            <Typography>
                                You can go back to your cart at any time by clicking on the shopping cart icon at the
