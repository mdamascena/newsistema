                ...
                <Grid container spacing={6}>
                    <Grid size={{ xs: 12, md: 4 }}>
                        <div className="flex flex-col items-center justify-center gap-y-4 bs-full text-center">
                            ...
                            <Typography>
                                We offers 284 Free Online courses from top tutors and companies to help you start or
                                advance your career skills. Learn online for free and fast today!
                            </Typography>
                                ...
                                <ReactPlayer
                                    ...
                                    light={
                                        <img
                                            ...
                                            alt="Thumbnail"
                                            className="is-full h-50! object-cover"
                                        />
                                    }
                                    playIcon={
                                        <CustomIconButton
