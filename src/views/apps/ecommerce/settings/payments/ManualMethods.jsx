        ...
        <Card>
            ...
            <CardContent>
                <Typography className="mbe-5">
                    Payments that are made outside your online store. When a customer selects a manual payment method
                    such as cash on delivery, you&apos;ll need to approve their order before it can be fulfilled.
                </Typography>
                <PaymentMethodButton />
            </CardContent>
        </Card>
