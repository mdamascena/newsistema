...
// Component Imports
import FgtsTableFilters from './FgtsTableFilters';
...
const FgtsListTable = ({ productData }) => {
    // States
    ...
    return (
        <>
            <Card>
                ...
                <FgtsTableFilters setData={setFilteredData} productData={data} />
                <Divider />
