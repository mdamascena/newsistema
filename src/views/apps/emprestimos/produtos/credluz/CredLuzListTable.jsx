...
// Component Imports
import CredLuzTableFilters from './CredLuzTableFilters';
...
const CredLuzListTable = ({ productData }) => {
    // States
    ...
    return (
        <>
            <Card>
                ...
                <CredLuzTableFilters setData={setFilteredData} productData={data} />
                <Divider />
...
export default CredLuzListTable;
