...
// Component Imports
import GeralTableFilters from './GeralTableFilters';
...
const GeralListTable = ({ productData }) => {
    // States
    ...
    return (
        <>
            <Card>
                ...
                <GeralTableFilters setData={setFilteredData} productData={data} />
                <Divider />
